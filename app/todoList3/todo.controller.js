(function() {
    ...
    TodoController.$inject = ['guidService', 'securityApiService'];

    function TodoController(guidService, securityApiService) {
        var vm = this;
        vm.add = add;
        vm.remove = remove;
        vm.todoList = [];
        ...
        function add() {
            ...
            securityApiService.post("addTodo", newItem).then(function(res) {
                console.log(res);
            })
        ...
        function init()
        {
            securityApiService.post("getTodo").then(function(res) {
                console.log(res);
                if(!res.data)
                    return;
